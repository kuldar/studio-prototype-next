export default [
  ...
  [
    { type: "id", label: "id", value: `"cjyr79un20001jxxwuzgtbgqe"` },
    { type: "string", label: "firstName", value: `"Some post"` },
    { type: "string", label: "lastName", value: `"This is a post"` },
    { type: "boolean", label: "isFeatured", value: true },
    { type: "object", label: "author", value: "User", preview: `{ id: "cjyr79un20001jxxwuzgtbgqe", firstName: “Bob", lastName: "Loblaw", ... }`, children: [
      { type: "id", label: "id", value: `"cjyr79un20001jxxwuzgtbgqe"` },
      { type: "string", label: "firstName", value: `"Bob"` },
      { type: "string", label: "lastName", value: `"Loblaw"` },
    ] },
